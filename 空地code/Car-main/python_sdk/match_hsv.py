...
def adjust_red_threshold(auto_expo):
    ...
    # 创建滑动条
    cv2.createTrackbar("H1_min", "HSV Threshold", 0, 179, lambda x: None)
    cv2.createTrackbar("H1_max", "HSV Threshold", 8, 179, lambda x: None)
    ...
    cv2.createTrackbar("S_min", "HSV Threshold", 100, 255, lambda x: None)
    cv2.createTrackbar("V_min", "HSV Threshold", 80, 255, lambda x: None)
