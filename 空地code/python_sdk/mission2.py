...
mission_points_list = []
for i in range(0, 6):
    mission_points_list.append(P(0, i))
for i in range(5, -1, -1):
    mission_points_list.append(P(1, i))
for i in range(0, 6):
    mission_points_list.append(P(2, i))
for i in range(5, -1, -1):
    mission_points_list.append(P(3, i))
for i in range(0, 6):
    mission_points_list.append(P(4, i))
