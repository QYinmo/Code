...
def postprocess(outs, conf_thres, image_shape, input_shape):
    ...
    scores = outs[:, 4]
    print(scores)
    for label_score in outs[:, 5:]:
        labels.append(np.argmax(label_score))
...
def main():
    ...
    model_path = "/Users/huangzhewei/Develop/Drone_maindev/python_sdk/model/best.onnx"
    ...
    while True:
        ...
        infer_and_draw(im0, ort_model, classes, conf_thres)
