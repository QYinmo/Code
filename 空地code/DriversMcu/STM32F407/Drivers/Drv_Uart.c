...
#define U1GetOneByte LD_Radar_GetOneByte
#define U2GetOneByte Uart_Wireless_GetOneByte
#define U3GetOneByte Uart_Screen_GetOneByte
#if OF_USE_UP_FLOW
#define U4GetOneByte UpFlow_GetOneByte
#else
